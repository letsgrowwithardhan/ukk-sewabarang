...
<?php
    echo "
    <td align=center><button><a href=editbarang.php?nomor=$baris[0]>Edit</a></button></td>
    <td align=center><button><a href=hapusbarang.php?id_barang=$baris[0] onclick='return confirm(\"Anda yakin data barang $baris[id_barang] akan dihapus?\")'>Hapus</a></button></td></tr></tbody>";
    $no++;
    }
    echo "</table>";
    ?>
