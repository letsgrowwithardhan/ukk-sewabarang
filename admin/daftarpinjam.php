...
<?php
    echo "
    <td align=center><button><a href=editpinjam.php?nomor=$baris[no_transaksi]>Edit</a></button></td>
    <td align=center><button><a href=hapuspinjam.php?no_transaksi=$baris[no_transaksi] onclick='return confirm(\"Anda yakin data barang $baris[no_transaksi] akan dihapus?\")'>Hapus</a></button></td></tr></tbody>";
    $no++;
    }
    echo "</table>";
    ?>
