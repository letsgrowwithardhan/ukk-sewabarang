...
$hasil=mysqli_query($konek,"SELECT tbpeminjaman.no_transaksi,tbuser.id_user,tbuser.nama,
    ...
    AND tbpeminjaman.id_barang=tbbarang.id_barang AND tbpeminjaman.status='tersewa' ");
...
<?php
    echo "
    <td align=center><button><a href=fbalik_user.php?nomor=$baris[no_transaksi] onclick='return confirm(\"Anda yakin data barang $baris[no_transaksi] akan diinputkan pengembalian?\")'>Kembali</a></button></td></tr></tbody>";
    $no++;
    }
    echo "</table>";
    ?>
