...
<?php include "koneksi.php";
    ...
    ?>
    <div class="container"> 
<form id="contact" action="baliksimpan_user.php" method="POST" enctype="multipart/form-data">
<h3>INPUT DATA PEMINJAMAN</h3>
<h4>Isikan data dengan lengkap</h4>
<fieldset>
<input placeholder="No Transaksi" type="text" name="no_transaksi" required autofocus value= "<?php echo "$data[0]" ?>" readonly>
</fieldset>
<fieldset>
<select name="id_user" value= "<?php echo "$data[1]" ?>" readonly>
    <?php
    include "koneksi.php";
...
<fieldset>
<select name="id_barang" value= "<?php echo "$data[2]" ?>" readonly>
    <?php
    include "koneksi.php";
...
<fieldset>
<input placeholder="Jumlah Pinjam" type="number" name="jml_pinjam" required value= "<?php echo "$data[3]" ?>" readonly>
</fieldset>
<fieldset>
<label>Tanggal Pinjam</label>
</fieldset>
<fieldset>
<input placeholder="Tanggal Pinjam" type="date" name="tgl_pinjam" required value= "<?php echo "$data[4]" ?>" readonly>
</fieldset>
<fieldset>
<label>Tanggal Batas Kembali</label>
</fieldset>
<fieldset>
<input placeholder="Tanggal Kembali" type="date" name="tgl_batas_kembali" required value= "<?php echo "$data[5]" ?>" readonly>
</fieldset>
<fieldset>
<input placeholder="Status" type="text" name="status" required value= "<?php echo "$data[6]" ?>" readonly>
</fieldset>
<fieldset>
<input placeholder="Denda" type="number" name="denda" hidden value= "<?php echo "$data[7]" ?>">
</fieldset>
<fieldset>
<input placeholder="Tanggal Kembali" type="date" name="tgl_kembali" required value= "<?php echo "$data[8]" ?>">
</fieldset>
<fieldset>
