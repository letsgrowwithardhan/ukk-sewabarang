...
<?php include "koneksi.php";
    ...
    ?>
    <div class="container"> 
<form id="contact" action="user_pinjam_simpan.php" method="POST" enctype="multipart/form-data">
...
<fieldset>
<label>Tanggal Batas Pinjam</label>
</fieldset>
<fieldset>
<input placeholder="Tanggal Batas Pinjam" type="date" name="tgl_batas_kembali" required>
</fieldset>
<fieldset>
