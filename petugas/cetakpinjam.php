    ...
    <center>
        ...
        <table border=1 style="" width=400>
            <tr>
                ...
                <th>Nama Barang</th>
                <th>Jumlah Pinjam</th>
                <th>Tanggal Pinjam</th></tr>
        <?php
        $no=1;
        $sql=mysqli_query($konek,"SELECT tbpeminjaman.no_transaksi,tbuser.id_user,tbuser.nama,
        tbbarang.id_barang,tbbarang.nama_barang,tbpeminjaman.jml_pinjam,tbpeminjaman.tgl_pinjam,tbpeminjaman.tgl_batas_kembali 
        from tbpeminjaman,tbbarang,tbuser where tbpeminjaman.id_user=tbuser.id_user 
        and tbpeminjaman.id_barang=tbbarang.id_barang");
