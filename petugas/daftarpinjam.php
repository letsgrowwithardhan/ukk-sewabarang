...
<?php
    echo "
    <td align=center><button><a href=hapuspinjam.php?id_barang=$baris[no_transaksi] onclick='return confirm(\"Anda yakin data barang $baris[id_barang] akan dihapus?\")'>Hapus</a></button></td></tr></tbody>";
    $no++;
    }
    echo "</table>";
    ?>
