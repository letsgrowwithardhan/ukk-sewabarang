...
<?php include "koneksi.php";
    ...
    ?>
    <div class="container"> 
<form id="contact" action="baliksimpan.php" method="POST" enctype="multipart/form-data">
...
<fieldset>
<input placeholder="Denda" type="number" name="denda" required value= "<?php echo "$data[7]" ?>">
</fieldset>
<fieldset>
