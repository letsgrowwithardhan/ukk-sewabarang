...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Jan 2026 pada 03.56
...
(1, 'Jaket Gorpcore', 'tas', 10, 'tas carrier.webp', '2026-01-28');
...
INSERT INTO `tbpeminjaman` (`no_transaksi`, `id_user`, `id_barang`, `jml_pinjam`, `tgl_pinjam`, `tgl_kembali`, `status`) VALUES
(1, 1001, 1, 1, '2026-01-30', '2026-01-30', 'pending');
